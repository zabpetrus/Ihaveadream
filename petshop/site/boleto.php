...
$numeroNota 		    = date("dmY"); //$_POST['Numero'];
$nossoNumero			= "001/0000587-4";
$NomeCobranca 			= "BANCO ITAÚ";
$linhaDigitavel 		= "34190."."01007"." "."00587.442938.".senha()." "."7"." ".senha().$final;
$CodigoCobranca 		= "341-7";
$dataVencimento 		= date('Y-m-d', strtotime('+5 days'));
$numeroDocumento 		= $numeroNota.'-'."1";
$dataProcessamento 		= date("Y-m-d");
$valorDocumento 		= $valor_final;
$NomeFantasia 			= $linha['nome'];
...
<div id="boleto_parceiro">
  ...
  <tr>
    ...
    <td><div class="titulo">QUANTIDADE</div>
      <div class="var"><?=$cont_produtos?></div></td>
    <td class="td_7_cb">&nbsp;</td>
    <td><div class="titulo">VALOR DOCUMENTO</div>
      <div class="var"><?=$valor_final?></div></td>
    <td class="td_7_cb">&nbsp;</td>
...
<!-- Aqui imprimimos a linha digitavel que pode ser calculada,neste caso é informada via post -->	
  ...
  <table class="tabelas" style="width:666px; border-left:solid; border-left-width:2px; border-left-color:#000000;" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <div class="var"></div><?=$valor_final?></td>
      <td class="td_7_cb">&nbsp;</td>
    ...
    <tr>
      ...
      <td rowspan="5" valign="top"><div class="titulo" style="margin-bottom:18px;">
        ...
        <div class="var"><strong>JUROS POR DIA DE ATRASO: R$3,10</strong><br />
        	...
        	<strong>D&Uacute;VIDAS LIGUE:(21)1234-4655 DPTO COBRAN&Ccedil;A</strong><BR/>
        	<strong>EMAIL: cobranca@petshop4mod.com.br</strong><br/>
